...
|---|---|---|
| [product/](product/vision.md) | vision, cas d'usage, règles d'écran | avant toute fonctionnalité |
| [architecture/](architecture/overview.md) | cœur pur, ports, trajectoire de montée en charge | avant de créer un module |
