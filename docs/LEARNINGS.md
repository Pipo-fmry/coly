...
| 2026-09-25 | Chronopost (via Ship24) écrit le lieu en tête du libellé (« MARSEILLE - FR - SHOP N  FOOD, Available at retrieval point »), champ lieu vide ; l'app affichait « Point relais Chronopost », sans carte | colis Fnac | événements normalisés à la lecture de la source (et des données stockées) ; tous les événements de mise en relais deviennent des faits « lieu » ; la ville sert à la carte quand l'adresse manque |
